...
struct AIComponent
{
    ...
    ,countdown_fleeing{3.0}, countdown_perception{0.5}, couldown_spawning{1.0}, countdown_heal{4.0}; // seconds
    double elapsed_change_position{ 1.0 }, elapsed_stop{ 1.0 }, elapsed_change_dir{ 1.0 }, elapsed_shoot{ 1.0 },
    elapsed_fleeing{1.0}, elapsed_perception{1.0}, elapsed_spawning{1.0}, elapsed_heal{1.0};

...
struct VAOUtils
{
    ...
    template <class T>
    static unsigned int generateAttribute(int id, int elementsPerEntry, std::vector<T> data, bool normalize, bool integer = false)
    {
    ...
    // static unsigned int generateBuffer(DarkMoon::Mesh& mesh)
    // {
    //     unsigned int vaoID;
    //     glGenVertexArrays(1, &vaoID);
    //     glBindVertexArray(vaoID);

    //     generateAttribute(0, 3, mesh.positions, false);
    //     if (mesh.normals.size() > 0)
    //     {
    //         generateAttribute(1, 3, mesh.normals, true);
    //     }
    //     if (mesh.textCoordss.size() > 0)
    //     {
    //         generateAttribute(2, 2, mesh.textCoordss, false);
    ...
    //         {
    //             // Compute tangents
    //             computeTangentBasis(mesh.positions, mesh.textCoordss, mesh.normals, tangents, bitangents);
    //         }
    //         else
    //         {
    ...
    static void generateDepthMap(unsigned int& depthMap, unsigned int& FBO, unsigned int width, unsigned int height) {

...
namespace DarkMoon {
    ...
    struct Triangle : Entity {
        ...
        Triangle(glm::vec2 v_1 = { 0.0f, 0.0f }, glm::vec2 v_2 = { 10.0f, 0.0f }, glm::vec2 v_3 = { 0.0f, 10.0f }, Color c = D_BLACK)
    ...
    struct Rectangle : Entity {
        ...
        Rectangle(glm::vec2 p = { 0.0f, 0.0f }, glm::vec2 s = { 10.0f, 10.0f }, Color c = D_BLACK)

...
#define KEY_VOLUME_MUTE            GLFW_KEY_VOLUME_MUTE
#define KEY_VOLUME_UP              GLFW_KEY_VOLUME_UP
#define KEY_VOLUME_DOWN            GLFW_KEY_VOLUME_DOWN
#define KEY_MEDIA_PLAY             GLFW_KEY_MEDIA_PLAY
#define KEY_MEDIA_PAUSE            GLFW_KEY_MEDIA_PAUSE
#define KEY_MEDIA_STOP             GLFW_KEY_MEDIA_STOP
#define KEY_MEDIA_NEXT_TRACK       GLFW_KEY_MEDIA_NEXT_TRACK
#define KEY_MEDIA_PREVIOUS_TRACK   GLFW_KEY_MEDIA_PREVIOUS_TRACK
#define KEY_MEDIA_FAST_FORWARD     GLFW_KEY_MEDIA_FAST_FORWARD
#define KEY_MEDIA_REWIND           GLFW_KEY_MEDIA_REWIND
